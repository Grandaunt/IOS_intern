...
@interface HXTagsView () <UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ((_tagAttribute.textColors || _tagAttribute.textColors.count > 0) && _tagAttribute.textColors.count == self.tags.count)
    {
        UIColor *color = _tagAttribute.textColors[indexPath.item];
