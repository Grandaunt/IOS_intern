...
open class ZJMessageController: UIViewController
{
...
extension ZJMessageController: UICollectionViewDelegateFlowLayout {
...
extension ZJMessageController: UICollectionViewDataSource {
...
fileprivate extension ZJMessageController {
    
    func addKeyboardObservers() {
        NotificationCenter.default.addObserver(self, selector: #selector(handleKeyboardDidChangeState), name: Notification.Name.UIKeyboardWillChangeFrame, object: nil)
