...
@class DHGuidePageHUD;

@protocol DHGuidePageHUDDelegate <NSObject>
@optional
- (void)DHGuidePageHUDWillHide:(DHGuidePageHUD *)hud;
- (void)DHGuidePageHUDHideAction:(DHGuidePageHUD *)hud;  //隐藏的操作
...
@property (nonatomic, weak) id<DHGuidePageHUDDelegate> delegate;
